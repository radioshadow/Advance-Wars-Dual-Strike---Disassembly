...
;----------------------------------------------------------------------------------------------------------------
	...
	.dh 655 						; Profile 1 (About) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 656 						; Profile 2 (D2D) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 657							; Profile 3 (Power) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 658 						; Profile 4 (Super Power) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh Theme_Nell 					; Theme ID
	...
	.dh 47 							; Single Win Quote 1 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 48 							; Single Win Quote 2 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 49 							; Single Win Quote 3 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 320 						; Switch Quote 1 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 321							; Switch Quote 2 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 488 						; Power Quote 1 Text ID
	.dh 0xF000  					; Pointer Set

	.dh 489 						; Power Quote 2 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 490 						; Power Quote 3 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 491 						; Power Quote 4 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 492 						; Power Quote 5 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 493 						; Power Quote 6 Text ID
	.dh 0xF000  					; Pointer Set
	
	.dw 0
	
	.dw name_Nell					; Pointer to compressed CO Name graphic
	.dw name_Nell					; Pointer to compressed CO Name graphic
	.dw name_Nell					; Pointer to compressed CO Name graphic
	.dw name_Nell					; Pointer to compressed CO Name graphic
	.dw name_Nell					; Pointer to compressed CO Name graphic
...
;----------------------------------------------------------------------------------------------------------------
	...
	.dh Tag_Star_3					; Tag 1 Stars
	.dw	0x152868 + ArmUS			; Tag 1 Pointer to Win Quotes (arm9.bin)
	
	.dh 0							; Tag 2 CO ID
	.dh 0							; Tag 2 Stars
	.dw	0							; Tag 2 Pointer to Win Quotes (arm9.bin)
	...
	.db	105							; Tag Firepower with Andy
	.db	105							; Tag Firepower with Max
	...
	.db	130							; Tag Firepower with Rachel

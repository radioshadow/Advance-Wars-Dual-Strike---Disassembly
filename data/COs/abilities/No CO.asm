...
;----------------------------------------------------------------------------------------------------------------
	...
	.dh 651 						; Profile 1 (About) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 652 						; Profile 2 (D2D) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 653							; Profile 3 (Power) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh 654 						; Profile 4 (Super Power) Text ID
	.dh 0xF000  					; Pointer Set
	
	.dh Theme_Andy 					; Theme ID
	...
	.dh 0 							; Single Win Quote 1 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Single Win Quote 2 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Single Win Quote 3 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Switch Quote 1 Text ID
	.dh 0x0000  					; Pointer Set

	.dh 0							; Switch Quote 2 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Power Quote 1 Text ID
	.dh 0x0000  					; Pointer Set

	.dh 0 							; Power Quote 2 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Power Quote 3 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Power Quote 4 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Power Quote 5 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dh 0 							; Power Quote 6 Text ID
	.dh 0x0000  					; Pointer Set
	
	.dw 0
	
	.dw name_No_CO					; Pointer to compressed CO Name graphic
	.dw name_No_CO					; Pointer to compressed CO Name graphic
	.dw name_No_CO					; Pointer to compressed CO Name graphic
	.dw name_No_CO					; Pointer to compressed CO Name graphic
	.dw name_No_CO					; Pointer to compressed CO Name graphic
...
;----------------------------------------------------------------------------------------------------------------
	...
	.dh 0							; Tag 1 CO ID
	.dh 0							; Tag 1 Stars
	.dw	0							; Tag 1 Pointer to Win Quotes (arm9.bin)
	...
	.db	100							; Tag Firepower with Von Volt

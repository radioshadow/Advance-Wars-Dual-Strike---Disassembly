...
;----------------------------------------------------------------------------------------------------------------
	...
	.dw	0xAB430 + RegionUS 		; Campaign / Survival - Dialog
	.dw	0xA5500 + RegionUS		; Campaign Terms - Dialog
	...
	.dw 0x199C4 + RegionUS		; Pointer to Map Data (LZ77 Compressed)
	.dw 0x19A84 + RegionUS		; Pointer to Map Data (LZ77 Compressed) - Hard Campaign
	.dw 0x3A8C8 + RegionUS		; Pointer to Unit Data
	.dw 0x3B978 + RegionUS		; Pointer to Unit Data - Hard Campaign
	
	.dh 0
	
	.db ID_Sasha				; P1 CO (Main)
	.db 0						; P1 CO (Partner)
